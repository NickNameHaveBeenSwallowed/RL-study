...
class MuZeroActor:
    ...
    def step(self, using_model, state):
        ...
        mcts = MCTS(
            ...
            discrete_support_size=self.config.discrete_support_size,
            discrete_floor=self.config.discrete_floor,
            discrete_ceiling=self.config.discrete_ceiling,
        ...
        mean_value = np.array(mcts.root.value)
