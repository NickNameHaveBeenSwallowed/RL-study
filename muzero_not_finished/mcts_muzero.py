from utils import inverse_value_reward_transfomer, inverse_discrete_transform
import numpy as np
...
class MCTS:
    ...
    def _simulations(self):
        ...
        value = inverse_discrete_transform(value, self.discrete_support_size, self.discrete_ceiling)[0]
        value = inverse_value_reward_transfomer(value)
        ...
        for action_prob in action_probs:
            ...
            reward = inverse_discrete_transform(reward, self.discrete_support_size, self.discrete_ceiling)[0]
            reward = inverse_value_reward_transfomer(reward)
